...
?>
 ...
 <div class="alert alert-warning text-sm shadow" role="alert">Günde sadece 1 kez ders çalışma süreni girebilirsin ! </div>

<div class="container mb-5">
        <form class="d-flex justify-content-center mt-5" action="php/dash.php?islem=derscalisma_kayit" method="POST">
          <div class="form-row align-items-center bg-light col-lg-4 p-3 rounded border border-primary shadow">
            <div class="container text-center my-3">
              <h5>Ders Çalışma Saati Ekranı</h5>
              Bugün kaç saat ders çalıştın.
            </div>

               <div class="col-auto">
                  <div class="input-group mb-2" style="width: 300px;">
                    <div class="input-group-prepend">
                      <div class="input-group-text text-muted" style="font-size: small;">Çalışma Süresi
                      </div>
                    </div>
                  <input type="number" min="0" class="form-control"  name="calisma_sure" autocomplete="off" required>
...
?>
<div class="alert alert-danger text-sm" role="alert">Günde sadece 1 kez ders çalışma süreni girebilirsin ! </div>
<?php
